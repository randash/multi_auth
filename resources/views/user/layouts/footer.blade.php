...
<script src="{{ url('/') }}/./assets/js/demo11/scripts.bundle.js" type="text/javascript"></script>
...
<script src="{{ url('/') }}/./assets/js/demo11/pages/dashboard.js" type="text/javascript"></script>
